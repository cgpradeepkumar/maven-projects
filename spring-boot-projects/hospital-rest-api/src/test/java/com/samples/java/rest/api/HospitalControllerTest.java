...
import com.samples.java.rest.api.Hospital;
import com.samples.java.rest.api.HospitalController;
...
public class HospitalControllerTest {
	...
	@Before
	public void setup() {
		this.mockMvc = MockMvcBuilders.standaloneSetup(new HospitalController()).build();
